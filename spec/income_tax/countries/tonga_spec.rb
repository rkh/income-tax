describe IncomeTax::Countries::Tonga do
  ...
  describe "from gross income of 100000" do
    ...
    its(:net_income)   { should be == 83740                        }
    its(:taxes)        { should be == 16260                        }
  end
  ...
  describe "from gross income of 100000000" do
    ...
    its(:net_income)   { should be == 80003740                     }
    its(:taxes)        { should be == 19996260                     }
  end
  ...
  describe "from net income of 100000" do
    ...
    its(:gross_income) { should be == 120325                       }
    its(:net_income)   { should be == 100000                       }
    its(:taxes)        { should be == 20325                        }
  end
  ...
  describe "from net income of 100000000" do
    ...
    its(:gross_income) { should be == 124995325                    }
    its(:net_income)   { should be == 100000000                    }
    its(:taxes)        { should be == 24995325                     }
  end
end
