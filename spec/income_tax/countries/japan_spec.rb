describe IncomeTax::Countries::Japan do
  ...
  describe 'from gross income of 100000000' do
    ...
    its(:rate)         { should be == Rational(83, 170) }
    its(:gross_income) { should be == 100_000_000                    }
    its(:net_income)   { should be == 51_177_000                     }
    its(:taxes)        { should be == 48_823_000                     }
  end
  ...
  describe 'from net income of 100000000' do
    ...
    let(:tax_year)     { 2015                                      }
    let(:income)       { 100_000_000 }
    its(:rate)         { should be == Rational(83, 168) }
    its(:gross_income) { should be == 197_646_000                    }
    its(:net_income)   { should be == 100_000_000                    }
    its(:taxes)        { should be == 97_646_000                     }
  end
end
