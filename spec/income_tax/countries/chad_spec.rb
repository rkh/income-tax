describe IncomeTax::Countries::Chad do
  ...
  describe 'from gross income of 100000000' do
    ...
    its(:rate)         { should be == Rational(167, 282) }
    its(:gross_income) { should be == 100_000_000                    }
    its(:net_income)   { should be == 40_780_000                     }
    its(:taxes)        { should be == 59_220_000                     }
  end
  ...
  describe 'from net income of 100000000' do
    ...
    let(:tax_year)     { 2015                                      }
    let(:income)       { 100_000_000 }
    its(:rate)         { should be == Rational(114, 191) }
    its(:gross_income) { should be == 248_050_000                    }
    its(:net_income)   { should be == 100_000_000                    }
    its(:taxes)        { should be == 148_050_000                    }
  end
end
