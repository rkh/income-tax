describe IncomeTax::Countries::Greece do
  ...
  describe 'from gross income of 30000' do
    ...
    its(:gross_income) { should be == 30_000                        }
    its(:net_income)   { should be == 22_900                        }
  ...
  describe 'from gross income of 100000' do
    ...
    its(:net_income)   { should be == 64_700                        }
    its(:taxes)        { should be == 35_300                        }
  end
  ...
  describe 'from gross income of 100000000' do
    ...
    its(:net_income)   { should be == 58_006_700                     }
    its(:taxes)        { should be == 41_993_300                     }
  end
  ...
  describe 'from net income of 30000' do
    ...
    its(:net_income)   { should be == 30_000 }
