describe IncomeTax::Countries::Singapore do
  ...
  describe 'tax year 2015' do
    ...
    describe 'from gross income of 100000' do
      ...
      its(:net_income)   { should be == 94_350                        }
    ...
    describe 'from gross income of 100000000' do
      ...
      its(:net_income)   { should be == 80_021_650                     }
      its(:taxes)        { should be == 19_978_350                     }
    end
  ...
  describe 'tax year 2017' do
    ...
    describe 'from gross income of 100000000' do
      ...
      its(:gross_income) { should be == 100_000_000                    }
      its(:net_income)   { should be == 78_025_850                     }
      its(:taxes)        { should be == 21_974_150                     }
    end
