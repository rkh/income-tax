describe IncomeTax::Countries::Fiji do
  ...
  describe 'from gross income of 100000' do
    ...
    its(:net_income)   { should be == 84_540                        }
    its(:taxes)        { should be == 15_460                        }
  end
  ...
  describe 'from gross income of 100000000' do
    ...
    its(:net_income)   { should be == 51_096_640                     }
    its(:taxes)        { should be == 48_903_360                     }
  end
  ...
  describe 'from net income of 100000' do
    ...
    its(:gross_income) { should be == 119_325                       }
    its(:net_income)   { should be == 100_000                       }
    its(:taxes)        { should be == 19_325                        }
  end
