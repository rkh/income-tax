describe IncomeTax::Countries::Philippines do
  ...
  describe "from gross income of 100000" do
    ...
    its(:net_income)   { should be == 85500                        }
    its(:taxes)        { should be == 14500                        }
  end
  ...
  describe "from gross income of 100000000" do
    ...
    its(:net_income)   { should be == 68035000                     }
    its(:taxes)        { should be == 31965000                     }
  end
  ...
  describe "from net income of 100000" do
    ...
    its(:gross_income) { should be == 118125                       }
    its(:net_income)   { should be == 100000                       }
    its(:taxes)        { should be == 18125                        }
  end
