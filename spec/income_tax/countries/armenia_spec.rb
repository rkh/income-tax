describe IncomeTax::Countries::Armenia do
  ...
  describe 'from gross income of 100000000' do
    ...
    its(:rate)         { should be == Rational(83, 417) }
    its(:gross_income) { should be == 100_000_000                    }
    its(:net_income)   { should be == 80_096_000                     }
    its(:taxes)        { should be == 19_904_000                     }
  end
  ...
  describe 'from net income of 100000000' do
    ...
    let(:tax_year)     { 2015                                      }
    let(:income)       { 100_000_000 }
    its(:rate)         { should be == Rational(52, 261) }
    its(:gross_income) { should be == 124_880_000                    }
    its(:net_income)   { should be == 100_000_000                    }
    its(:taxes)        { should be == 24_880_000                     }
  end
end
