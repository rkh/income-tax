describe IncomeTax::Countries::UnitedKingdom do
  ...
  describe 'tax year 2008' do
    ...
    describe 'from gross income of 100000' do
      ...
      its(:net_income)   { should be == 66_900                        }
      its(:taxes)        { should be == 33_100                        }
    end
    ...
    describe 'from gross income of 100000000' do
      ...
      its(:net_income)   { should be == 55_014_400                     }
      its(:taxes)        { should be == 44_985_600                     }
    end
    ...
    describe 'from net income of 100000000' do
      ...
      its(:gross_income) { should be == 181_792_000                    }
      its(:net_income)   { should be == 100_000_000                    }
      its(:taxes)        { should be == 81_792_000                     }
    end
  end
  ...
  describe 'tax year 2015' do
    ...
    describe 'from gross income of 100000' do
      ...
      its(:gross_income) { should be == 100_000                       }
      its(:net_income)   { should be == 66_357                        }
      its(:taxes)        { should be == 33_643                        }
    end
    ...
    describe 'from gross income of 100000000' do
      ...
      its(:gross_income) { should be == 100_000_000                    }
      its(:net_income)   { should be == 55_013_857                     }
      its(:taxes)        { should be == 44_986_143                     }
    end
