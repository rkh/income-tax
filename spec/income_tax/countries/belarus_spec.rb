describe IncomeTax::Countries::Belarus do
  ...
  describe 'from gross income of 100000000' do
    ...
    its(:net_income)   { should be == 88_000_000                     }
    its(:taxes)        { should be == 12_000_000                     }
  end
  ...
  describe 'from net income of 100000000' do
    ...
    let(:income)       { 100_000_000 }
    its(:rate)         { should be == Rational(3, 25)              }
    its(:gross_income) { should be == '113636363.636363636'.to_d   }
    its(:net_income)   { should be == 100_000_000 }
    its(:taxes)        { should be == '13636363.6363636364'.to_d }
  end
end
