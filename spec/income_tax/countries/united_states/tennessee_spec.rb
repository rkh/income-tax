describe IncomeTax::Countries::UnitedStates::Tennessee do
  subject(:result) { IncomeTax::Countries::UnitedStates.new(income: income, income_type: type, tax_year: tax_year, state: 'Tennessee') }
  let(:type) { :gross }
