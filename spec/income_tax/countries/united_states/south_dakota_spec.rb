describe IncomeTax::Countries::UnitedStates::SouthDakota do
  subject(:result) { IncomeTax::Countries::UnitedStates.new(income: income, income_type: type, tax_year: tax_year, state: 'South Dakota') }
  let(:type) { :gross }
