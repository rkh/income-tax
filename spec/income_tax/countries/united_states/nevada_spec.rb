describe IncomeTax::Countries::UnitedStates::Nevada do
  subject(:result) { IncomeTax::Countries::UnitedStates.new(income: income, income_type: type, tax_year: tax_year, state: 'Nevada') }
  let(:type) { :gross }
