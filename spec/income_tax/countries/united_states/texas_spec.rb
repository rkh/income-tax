describe IncomeTax::Countries::UnitedStates::Texas do
  subject(:result) { IncomeTax::Countries::UnitedStates.new(income: income, income_type: type, tax_year: tax_year, state: 'Texas') }
  let(:type) { :gross }
