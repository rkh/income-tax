describe IncomeTax::Countries::UnitedStates::Alaska do
  subject(:result) { IncomeTax::Countries::UnitedStates.new(income: income, income_type: type, tax_year: tax_year, state: 'Alaska') }
  let(:type) { :gross }
